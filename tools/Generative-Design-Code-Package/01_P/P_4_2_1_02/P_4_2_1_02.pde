...
void keyPressed() {
  ...
  if (key == '1') layer1Items = generateCollageItems("layer1", (int)random(500,1000), 0,height/2,PI*5,height, 0.1,0.5, 0,0);
  if (key == '2') layer2Items = generateCollageItems("layer2", (int)random(0,0), 0,height*0.15,PI*5,150, 0.1,random(0.3,0.8), -PI/6,PI/6);
  if (key == '3') layer3Items = generateCollageItems("layer3", (int)random(0,0), 0,height*0.66,PI*5,height*0.66, 0.1,random(0.2,0.5), -0.05,0.05);
